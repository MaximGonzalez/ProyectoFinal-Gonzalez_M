"""
Django settings for Proyecto_GONZALEZ project.
...
SECRET_KEY = 'django-insecure-_lj*3*x&07$o4j-1jwr&@dcc6*(q+&)4w*i#7kvqa=zp@i8(go'
...
ROOT_URLCONF = 'Proyecto_GONZALEZ.urls'
...
WSGI_APPLICATION = 'Proyecto_GONZALEZ.wsgi.application'
